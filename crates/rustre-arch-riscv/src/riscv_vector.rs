...
impl VecOp {
    ...
    ///
    /// Split across two tables so each stays readable on its own.
    #[must_use]
    pub const fn mnemonic(self) -> &'static str {
        match self.mnemonic_arith() {
            Some(m) => m,
            None => self.mnemonic_rest(),
        }
    }

    /// Mnemonics for the first half of the opcode table.
    #[must_use]
    const fn mnemonic_arith(self) -> Option<&'static str> {
        match self {
                Self::Vadd => Some("vadd"),
                Self::Vsub => Some("vsub"),
                Self::Vrsub => Some("vrsub"),
                Self::Vmul => Some("vmul"),
                Self::Vmulh => Some("vmulh"),
                Self::Vmulhu => Some("vmulhu"),
                Self::Vmulhsu => Some("vmulhsu"),
                Self::Vdiv => Some("vdiv"),
                Self::Vdivu => Some("vdivu"),
                Self::Vrem => Some("vrem"),
                Self::Vremu => Some("vremu"),
                Self::Vand => Some("vand"),
                Self::Vor => Some("vor"),
                Self::Vxor => Some("vxor"),
                Self::Vmin => Some("vmin"),
                Self::Vminu => Some("vminu"),
                Self::Vmax => Some("vmax"),
                Self::Vmaxu => Some("vmaxu"),
                Self::Vsll => Some("vsll"),
                Self::Vsrl => Some("vsrl"),
                Self::Vsra => Some("vsra"),
                Self::Vssrl => Some("vssrl"),
                Self::Vssra => Some("vssra"),
                Self::Vsadd => Some("vsadd"),
                Self::Vsaddu => Some("vsaddu"),
                Self::Vssub => Some("vssub"),
                Self::Vssubu => Some("vssubu"),
                Self::Vfadd => Some("vfadd"),
                Self::Vfsub => Some("vfsub"),
                Self::Vfmul => Some("vfmul"),
                Self::Vfdiv => Some("vfdiv"),
                Self::Vfsqrt => Some("vfsqrt"),
                Self::Vfneg => Some("vfneg"),
                Self::Vfabs => Some("vfabs"),
                Self::Vfmin => Some("vfmin"),
                Self::Vfmax => Some("vfmax"),
                Self::Vfmadd => Some("vfmadd"),
                Self::Vfnmadd => Some("vfnmadd"),
                Self::Vfmsub => Some("vfmsub"),
                Self::Vfnmsub => Some("vfnmsub"),
                Self::Vfcvt => Some("vfcvt"),
                Self::Vfwcvt => Some("vfwcvt"),
                Self::Vfncvt => Some("vfncvt"),
                Self::Vmseq => Some("vmseq"),
                Self::Vmsne => Some("vmsne"),
                Self::Vmslt => Some("vmslt"),
                Self::Vmsltu => Some("vmsltu"),
                Self::Vmsle => Some("vmsle"),
                Self::Vmsleu => Some("vmsleu"),
                Self::Vmsgt => Some("vmsgt"),
                Self::Vmsgtu => Some("vmsgtu"),
                Self::Vmsge => Some("vmsge"),
                Self::Vmsgeu => Some("vmsgeu"),
                Self::Vredsum => Some("vredsum"),
                Self::Vredand => Some("vredand"),
                Self::Vredor => Some("vredor"),
                Self::Vredxor => Some("vredxor"),
                Self::Vredmin => Some("vredmin"),
                Self::Vredminu => Some("vredminu"),
                Self::Vredmax => Some("vredmax"),
                Self::Vredmaxu => Some("vredmaxu"),
                Self::Vfredsum => Some("vfredsum"),
                Self::Vfredmin => Some("vfredmin"),
            _ => None,
        }
    }

    /// Mnemonics for the second half of the opcode table.
    #[must_use]
...
/// Every [`VecOp`] variant, in declaration order.
///
/// Held as a `static` table rather than built inside a function so the list
/// itself is one reviewable block of data.
