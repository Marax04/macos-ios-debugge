...
impl MobileJadxConfigWithDeobfTool { #[must_use] pub fn definition() -> ToolDefinition { ToolDefinition { name: "mobile_jadx_config_with_deobfuscate".to_string(), description: "rustre_mobile_jadx::JadxConfig::with_deobfuscate".to_string(), input_schema: json!({"type":"object","properties":{}}), parameters: Value::Null } } }
...
impl MobileJadxProjectMockTool { #[must_use] pub fn definition() -> ToolDefinition { ToolDefinition { name: "mobile_jadx_project_mock".to_string(), description: "rustre_mobile_jadx::DecompiledProject::mock".to_string(), input_schema: json!({"type":"object","properties":{}}), parameters: Value::Null } } }
#[async_trait] impl ToolHandler for MobileJadxProjectMockTool { async fn call(&self, _args: Value) -> Result<ToolResult, McpError> { let p = rustre_mobile_jadx::DecompiledProject::mock(); Ok(ToolResult::text(json!({"total":p.total,"failed":p.failed,"classes":p.classes.len(),"source":"rustre_mobile_jadx::DecompiledProject::mock"}).to_string())) } }

pub struct MobileJadxProjectSuccessRateTool;
impl MobileJadxProjectSuccessRateTool { #[must_use] pub fn definition() -> ToolDefinition { ToolDefinition { name: "mobile_jadx_project_success_rate".to_string(), description: "rustre_mobile_jadx::DecompiledProject::success_rate".to_string(), input_schema: json!({"type":"object","properties":{}}), parameters: Value::Null } } }
#[async_trait] impl ToolHandler for MobileJadxProjectSuccessRateTool { async fn call(&self, _args: Value) -> Result<ToolResult, McpError> { let p = rustre_mobile_jadx::DecompiledProject::mock(); Ok(ToolResult::text(json!({"success_rate":p.success_rate(),"source":"rustre_mobile_jadx::DecompiledProject::success_rate"}).to_string())) } }

pub struct MobileJadxProjectFindClassTool;
impl MobileJadxProjectFindClassTool { #[must_use] pub fn definition() -> ToolDefinition { ToolDefinition { name: "mobile_jadx_project_find_class".to_string(), description: "rustre_mobile_jadx::DecompiledProject::find_class on mock project".to_string(), input_schema: json!({"type":"object","properties":{"name":{"type":"string"}},"required":["name"]}), parameters: Value::Null } } }
#[async_trait] impl ToolHandler for MobileJadxProjectFindClassTool { async fn call(&self, args: Value) -> Result<ToolResult, McpError> { let n = args.get("name").and_then(Value::as_str).ok_or_else(|| McpError::InvalidParams("missing 'name'".into()))?; let p = rustre_mobile_jadx::DecompiledProject::mock(); let found = p.find_class(n).map(|c| c.class_name.clone()); Ok(ToolResult::text(json!({"query":n,"found":found,"source":"rustre_mobile_jadx::DecompiledProject::find_class"}).to_string())) } }

pub struct MobileJadxProjectInPackageTool;
impl MobileJadxProjectInPackageTool { #[must_use] pub fn definition() -> ToolDefinition { ToolDefinition { name: "mobile_jadx_project_in_package".to_string(), description: "rustre_mobile_jadx::DecompiledProject::in_package on mock project".to_string(), input_schema: json!({"type":"object","properties":{"pkg":{"type":"string"}},"required":["pkg"]}), parameters: Value::Null } } }
#[async_trait] impl ToolHandler for MobileJadxProjectInPackageTool { async fn call(&self, args: Value) -> Result<ToolResult, McpError> { let pkg = args.get("pkg").and_then(Value::as_str).ok_or_else(|| McpError::InvalidParams("missing 'pkg'".into()))?; let p = rustre_mobile_jadx::DecompiledProject::mock(); let names: Vec<String> = p.in_package(pkg).iter().map(|c| c.class_name.clone()).collect(); Ok(ToolResult::text(json!({"pkg":pkg,"classes":names,"source":"rustre_mobile_jadx::DecompiledProject::in_package"}).to_string())) } }

pub struct MobileJadxClassStaticMethodsTool;
impl MobileJadxClassStaticMethodsTool { #[must_use] pub fn definition() -> ToolDefinition { ToolDefinition { name: "mobile_jadx_class_static_methods".to_string(), description: "rustre_mobile_jadx::JavaClass::static_methods on Utils of mock project".to_string(), input_schema: json!({"type":"object","properties":{}}), parameters: Value::Null } } }
#[async_trait] impl ToolHandler for MobileJadxClassStaticMethodsTool { async fn call(&self, _args: Value) -> Result<ToolResult, McpError> { let p = rustre_mobile_jadx::DecompiledProject::mock(); let names: Vec<String> = p.find_class("Utils").map(|c| c.static_methods().iter().map(|m| m.name.clone()).collect()).unwrap_or_default(); Ok(ToolResult::text(json!({"class":"Utils","static_methods":names,"source":"rustre_mobile_jadx::JavaClass::static_methods"}).to_string())) } }

pub struct MobileJadxClassNativeMethodsTool;
impl MobileJadxClassNativeMethodsTool { #[must_use] pub fn definition() -> ToolDefinition { ToolDefinition { name: "mobile_jadx_class_native_methods".to_string(), description: "rustre_mobile_jadx::JavaClass::native_methods on MainActivity of mock project".to_string(), input_schema: json!({"type":"object","properties":{}}), parameters: Value::Null } } }
#[async_trait] impl ToolHandler for MobileJadxClassNativeMethodsTool { async fn call(&self, _args: Value) -> Result<ToolResult, McpError> { let p = rustre_mobile_jadx::DecompiledProject::mock(); let names: Vec<String> = p.find_class("MainActivity").map(|c| c.native_methods().iter().map(|m| m.name.clone()).collect()).unwrap_or_default(); Ok(ToolResult::text(json!({"class":"MainActivity","native_methods":names,"source":"rustre_mobile_jadx::JavaClass::native_methods"}).to_string())) } }

pub struct MobileJadxCliConfigDefaultTool;
impl MobileJadxCliConfigDefaultTool { #[must_use] pub fn definition() -> ToolDefinition { ToolDefinition { name: "mobile_jadx_cli_config_default".to_string(), description: "rustre_mobile_jadx::CliJadxConfig::default".to_string(), input_schema: json!({"type":"object","properties":{}}), parameters: Value::Null } } }
...
impl MobileJadxCliFindInPathTool { #[must_use] pub fn definition() -> ToolDefinition { ToolDefinition { name: "mobile_jadx_cli_find_in_path".to_string(), description: "rustre_mobile_jadx::CliJadxRunner::find_jadx_in_path".to_string(), input_schema: json!({"type":"object","properties":{}}), parameters: Value::Null } } }
