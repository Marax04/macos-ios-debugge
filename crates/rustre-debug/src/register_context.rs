...
impl RegisterSet {
    ...
    fn x86_64_regs() -> Vec<RegMeta> {
        vec![
            ...
            RegMeta::new("rsi", 64, "Source Index").with_aliases(&["esi", "si"]),
            RegMeta::new("rdi", 64, "Destination Index").with_aliases(&["edi", "di"]),
            RegMeta::new("rbp", 64, "Base Pointer").with_aliases(&["ebp", "bp"]),
            RegMeta::new("rsp", 64, "Stack Pointer").with_aliases(&["esp", "sp"]),
