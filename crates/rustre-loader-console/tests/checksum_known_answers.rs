//! Known-answer test for `switch_formats::adler32`.
//!
...
//! `a = 1`) would not break any build: NCA/NSO checksums would simply stop
//! verifying, which is a silent failure.
//!
...
use rustre_loader_console::switch_formats::adler32;
