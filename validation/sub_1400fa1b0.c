...
__int64 __fastcall sub_1400FA1B0(int *a1, int *a2, int a3, int *a4) {
    __int64 rsp;
    int arg_8;
    __int64 v_20;
    int v_28;
            ...
            if (v7 == 0) {
                ...
                if (result != 1) {
                    ...
                    do {
                        ...
                        xmm1 = _mm_cmpgt_epi8(xmm1, *(__int64 *)((__int64)src + (__int64)a1));
                        xmm1 = _mm_or_si128(xmm1, xmm0);
                        _mm_store_si128((__m128i *)((__int64)src + (__int64)a1), xmm1);
                        xmm1 = _mm_setzero_si128();
                        xmm1 = _mm_cmpgt_epi8(xmm1, *(__int64 *)((__int64)src + (__int64)a1 + 16));
                        xmm1 = _mm_or_si128(xmm1, xmm0);
                        _mm_store_si128((__m128i *)((__int64)src + (__int64)a1 + 16), xmm1);
                        a1 += 32;
                        a2 -= 2;
                    } while ((a2 != 0));
                    if ((result & 1) != 0) {
                        xmm0 = _mm_setzero_si128();
                        xmm0 = _mm_cmpgt_epi8(xmm0, *(__int64 *)((__int64)src + (__int64)a1));
                        xmm0 = _mm_or_si128(xmm0, _mm_load_si128((__m128i *)&off_1401086B0));
                        _mm_store_si128((__m128i *)((__int64)src + (__int64)a1), xmm0);
                    }
                } else {
                    a1 = 0;
                    return (__int64)a1;
            ...
            if (a1 != 0) {
                ...
                if (ptr != 0) {
                    ...
                    do {
                        ...
                        src2 = v10 - 1;
                        src2 = (__int64 *)((__int64)(__int64)src2 & v10);
                        --v5;
                        v8 >>= 57;
                        v10 = a2 - 16;
                        v10 &= result;
