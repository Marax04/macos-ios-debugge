...
__int64 __fastcall sub_140033660(__int64 *a1) {
    __int64 arg_10;
    __int64 arg_18;
    int arg_20;
    int arg_60;
        ...
        while (result != -1) {
            ...
            *a1 = v4;
            ...
            if (v4 == result) {
                ...
                a1 = 1;
                result = 0;
                /* cmpxchg %(__int64)a1, off_14012D034 */;
