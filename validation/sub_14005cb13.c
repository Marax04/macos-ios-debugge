...
__int64 __fastcall sub_14005CB13(size_t *a1, size_t *a2) {
    __int64 rsp;
    int arg_1;
    __int64 arg_10;
    __int64 arg_18;
        ...
        if (a2 == 1) {
            ...
            if (a2 != 43) {
                if (a2 != 45) {
                    a1 = 0;
                    a2 = 0;
                    result = *(__int64 *)((__int64)i4 + (__int64)a1);
                    result += 0xFFFFFFD0;
                    while (result <= 9) {
                        ...
                        if (a1 >= 31) {
                                                                                        ...
                                                                                        if (i->field_2 == 34) {
                                                                                            if (dst != 2) {
                                                                                                ...
                                                                                                *i2 = 3;
                                                                                                ...
                                                                                                v11 = 1;
                                                                                                dst = 2;
                                                                                                i4 = (__int64 *)((__int64)(__int64)i4 << 1);
                                                                                                if (i4 != 0) {
                                                                                                    off_140108030();
                                                                                                    i3 = (__int64 *)v_40;
                            ...
                            if (((__int64)i2 & 3) == 0) {
                                ...
                                if (a1 < 656) {
                                    ...
                                    if (v11 <= 11) {
                                        ...
                                        if ((!(((__int64)a2 >> v11) & 1))) {
                                            if (a1 == 2) {
                                                ...
                                                a1 = __ROR2__(a1, 4);
                                                i3 = (a1 < 164) ? 1 : 0;
                                                i3 = (__int64 *)((__int64)(__int64)i3 | 28);
                                            }
                                        } else {
                                        }
                                    }
                                    ...
                                    if (a1 < 10) {
                                        a1 = &off_14011E6D2;
                                        i3 = *(__int64 *)((__int64)a2 + (__int64)a1);
                                    }
                                }
                            } else {
                                a1 = v11 - 2;
                                                                                            ...
                                                                                            if (v_58 != 3) {
                                                                                                if (v_58 == 2) {
                                                                                                    ...
                                                                                                    if (v_58 != 1) {
                                                                                                        ...
                                                                                                        i3 = result;
                                                                                                        i3 = (__int64 *)((__int64)(__int64)i3 >> 32);
                                                                                                        dst = result;
                                                                                                        ...
                                                                                                        if (v_58 != 1) {
                                                                                                            ...
                                                                                                            v4 = (__int64 *)((__int64)(__int64)v4 & (__int64)i4);
                                                                                                            v_70 = 1;
                                                                                                            i4 = (__int64 *)((__int64)(__int64)i4 | (__int64)v4);
                                                                                                            v_78 = (__int64)i4;
                                                                                                            v_80 = (__int64)result;
                                                                                                            v_81 = v7;
                                                                                                            v_82 = (__int64)src;
            ...
            if (a2 == 0) {
                ...
                if (*i4 != 43) {
                    ...
                    if (a2 >= 3) {
                        ...
                        result = 0;
                        while (a2 != a1) {
                            src = *(__int64 *)((__int64)i4 + (__int64)a1);
                            src += 0xFFFFFFD0;
                            result = (__int64 *)((__int64)(__int64)(__int64)result * (__int64)i3); /* unsigned; high half in a2 */;
