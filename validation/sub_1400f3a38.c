...
__int64 __fastcall sub_1400F3A38(__int64 *a1, int *a2, size_t a3, __int64 a4) {
    __int64 rsp;
    int arg_40;
    int arg_8;
    __int64 arg_808;
                ...
                if (v7 != result) {
                    ...
                    if (ptr3 == 0) {
                        ...
                        if (src != 0) {
                            ...
                            v9 = 0;
                            do {
                                xmm0 = _mm_loadu_si128((__m128i *)&*(__int64 *)(rsp + v9 + 0x848));
                                xmm1 = _mm_loadu_si128((__m128i *)&*(__int64 *)(rsp + v9 + 0x858));
                                _mm_store_si128((__m128i *)&v_50, xmm1);
                                _mm_store_si128((__m128i *)&v_40, xmm0);
                                xmm0 = _mm_loadu_si128((__m128i *)&off_140110048);
                                _mm_storeu_si128((__m128i *)&*(__int64 *)(rsp + v9 + 0x848), xmm0);
                                xmm0 = _mm_loadu_si128((__m128i *)&off_140110058);
                                _mm_storeu_si128((__m128i *)&*(__int64 *)(rsp + v9 + 0x858), xmm0);
                                a1 = (__int64 *)v7;
                                ((__int64 (*)())(v_40))();
                                v9 += 32;
                            } while (src != v9);
                    ...
                    if (result < 64) {
                        ...
                        *(__int64 *)((__int64)a1 + (__int64)result + 8) = v7;
                    ...
                    do {
                        ...
                        *(__int64 *)rsp = *(__int64 *)rsp | 0;
                        ...
                        src = result;
                        ptr = (struct Struct_1_t *)v9;
                        sub_1400F27F0(result, v9, 0x808);
