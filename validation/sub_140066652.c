...
extern __int64 off_140116BCE;
extern __int64 off_140116BD0;
extern __int64 off_140115AC0;
extern __int64 off_14011AF40;
extern __int64 off_1401162A8;

__int64 __fastcall sub_140066652(size_t *a1, int *a2, int a3, int a4) {
    __int64 rsp;
    int arg_1;
    __int64 arg_10;
    int arg_18;
    ...
    *a1 = *a1 + (__int64)a2;
    result = &off_140116BCE;
    v_f0 = (__int64)result;
    v_f8 = 2;
    v_100 = 3;
    result = &off_140116BD0;
    ...
    if (v3 != 2) {
        ...
        arg_10 = (__int64)a2;
        arg_18 = (int)a1;
        result = (__int64 *)((__int64)(__int64)result & 254);
        if (result != 48) {
            arg_10 = v2;
            arg_18 = v8;
            ...
            if (a2 != 3) {
                ...
                if (!((v8 < 0))) {
                    ...
                    result = (__int64 *)v3;
                    result -= v7;
                    if (a3 > result) JUMPOUT(0x140067500);
                    i = (struct Struct_1_t *)v_88;
                    v2 += v9;
                    a1 = ptr + v7;
                    v2 = a3;
                    sub_1400F27F0(a1, v2, a3, 8);
                    v7 += v2;
                    a1 = rsp + 288;
