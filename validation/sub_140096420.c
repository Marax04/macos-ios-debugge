...
__int64 __fastcall sub_140096420(size_t *a1, size_t *a2, size_t *a3, size_t *a4) {
    __int64 rsp;
    int arg_8;
    int v_110;
    int v_118;
    ...
    if (a2 >= 33) {
        ...
        do {
            ...
            while (!((v8 < 0))) {
                ...
                v_3c = (__int64)v8;
                if (v11 >= 64) {
                    sub_140097200(ptr, result, a3, a4);
                    v8 = result;
                    v8 = (__int64 *)((__int64)v8 - (__int64)ptr);
                    a1 = (size_t *)v8;
                    ...
                    v_40 = (__int64)v11;
                    if ((v_48 == 0)) {
                        if (src2 < v11) JUMPOUT(0x140096e2a);
                        src2 = v11;
                        ...
                        do {
                            ...
                            if (result >= a3) {
                                ...
                                if (a2 == v11) {
                                    ...
                                    if ((a2 == 0)) {
                                        ...
                                        if (v2 == 0) {
                                            ...
                                            do {
                                                ...
                                                if (result >= a2) {
                                                    ...
                                                    if (v2 == v9) {
                                                        v8 = (__int64 *)i;
                                                        v8 = (__int64 *)((__int64)(__int64)v8 << 4);
                                                        sub_1400F27F0(ptr, src, v8, a4);
                                                        v2 = v9;
                                                        v2 -= i;
                                                        if (!((v2 == 0))) {
                                                            ptr = (struct Struct_1_t *)((__int64)ptr + (__int64)v8);
                                                            result = i + 1;
                                                            if (v9 != result) {
                                                                a1 = (size_t *)v2;
                                                                    ...
                                                                    if (v2 >= 2) {
                                                                        ...
                                                                        if (v2 <= 15) {
                                                                            if (v2 <= 7) {
                                                                                ...
                                                                                v11 = *(__int64 *)((__int64)ptr + (__int64)a2);
                                                                                v5 = *(__int64 *)((__int64)ptr + (__int64)v5);
                                                                                src2 = result;
                                                                                if (v11 < v5) src2 = a4;
                                                                                if (src3 < *(__int64 *)((__int64)ptr + (__int64)a3)) src2 = a1;
                                                                                ...
                                                                                a3 = (size_t *)((__int64)(__int64)a3 << 4);
                                                                                v11 = *(__int64 *)((__int64)a3 + (__int64)src3);
                                                                        ...
                                                                        do {
                                                                            ...
                                                                            if (v8 < v9) {
                                                                                ...
                                                                                if (src != a2) JUMPOUT(0x140096e6c);
                                                                                a1 += 16;
                                                                                if (result != a1) JUMPOUT(0x140096e6c);
                                                                                return (__int64)a1;
                                                                            }
                                                                            src2 = (__int64 *)a1;
                                                                            return (__int64)src2;
                                                ...
                                                do {
                                                    a3 = *(__int64 *)((__int64)ptr + (__int64)v8);
                                                    a1 -= 16;
                                                    a4 = (size_t *)i;
                                                    a4 = (size_t *)((__int64)(__int64)a4 << 4);
                                                    a3 = a1;
                                        ...
                                        if (v11 < v2) JUMPOUT(0x140096e2c);
                                        i += (__int64)ptr;
                                        result = rsp + 104;
                                        v_28 = (__int64)result;
                                        v8 = (__int64 *)v_3c;
                                        v_20 = (__int64)v8;
                                        sub_140096420(i, a2, src, src2);
                                        v11 = (__int64 *)v2;
                                        return (__int64)v11;
                                    }
                                    result = ptr + i;
                            ...
                            do {
                                ...
                                v5 = (__int64 *)v2;
                                v5 = (__int64 *)((__int64)(__int64)v5 << 4);
                                if (a4 < *(__int64 *)((__int64)ptr + (__int64)v8)) a1 = src;
                                xmm0 = _mm_loadu_si128((__m128i *)result);
            ...
            v_20 = 1;
            sub_140095DA0(ptr, v11, src, src2);
            return v_20;
        } while (v2 >= 33);
        return v_20;
    }
